...
class TestNonlinearDM_2BarsTruss(unittest.TestCase):
    ...
    def test_snap_through(self):
        ...
        result_up = NonlinearDisplacementMethod.incremental_newton_raphson_procedure(
            structure_up,
            loads,
            n_steps=100
        )
        
        result_down = NonlinearDisplacementMethod.incremental_newton_raphson_procedure(
            structure_down,
            loads,
            n_steps=100
        )
