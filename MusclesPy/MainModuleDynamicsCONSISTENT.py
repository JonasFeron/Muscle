...
def main(): # START READING FROM HERE
    ...
    resultPath = r.WriteResultFile(dataPath,r.FileDynamicCONSISTENTResult,key,output_str)
...
def core(DataString):
    ...
    if isinstance(data, d.SharedData):#check that data is a SharedData object !
        ...
        Struct.ModuleDynamics_CONSISTENT(data) #do some calculations in python
