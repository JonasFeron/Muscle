...
namespace Muscle.Components.CreateModel
{
    ...
    public class MaterialListComponent : GH_Component
    {
        ...
        /// </summary>
        public MaterialListComponent() : base("Material list", "List M", "Choose one of the multiple default materials via the right click menu.", GHAssemblyName, Folder2_ConstructFEM) { }
