...
namespace Muscle.Dynamics
{
    public class DynamicSolverCONSISTENTComponent : GH_Component
    {
        ...
        /// </summary>
        public DynamicSolverCONSISTENTComponent()
          : base("Dynamics Solver CONSISTENT", "DSC",
                "Compute the frequency(ies) and the mode(s) of the struture having a certain mass on each node. The computation is done on the state of the structure. It includes the influence of Lfree (pretension) and the possible applied load.Consistent Mass matrix is used",
              "Muscles", "Dynamics")
        {
        }
        ...
        {
            get { return new Guid("1b5d394829f546b99cfa049dba959dd0"); }
        }
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddGenericParameter("Element mass (kg/element)", "Element Mass (kg/elem)", "The mass of all elements.", GH_ParamAccess.list);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            List <double> MassAllElements = new List<double>();
            ...
            if (!DA.GetDataList(2, MassAllElements)) { }
            if (!DA.GetData(3, ref MaxFreqWtd)) { } //Number of frequencies/mode that the user want to compute
            ...
            SharedData data = new SharedData(structure, DynMassIN, MassAllElements, MaxFreqWtd); //Object data contains all the essential informations of structure + the dynMass considered
            ...
            if (AccessToAll.pythonManager != null) // run calculation in python by transfering the data base as a string. 
            {
                ...
                result_str = AccessToAll.pythonManager.ExecuteCommand(AccessToAll.DynSolveCONSISTENT, Data_str);
