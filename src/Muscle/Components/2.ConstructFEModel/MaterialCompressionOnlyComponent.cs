...
namespace Muscle.Components.ConstructFEModel
{
    ...
    /// </summary>
    public class MaterialCompressionOnlyComponent : GH_Component
    {
        ...
        /// </summary>
        public MaterialCompressionOnlyComponent() : base("Construct Material - Compression Only", "M", "Define a material with linear properties in compression, and null stiffness and strength in tension.", GHAssemblyName, Folder2_ConstructFEM) { }
        ...
        /// </summary>
        public override Guid ComponentGuid { get { return new Guid("a029c1d7-65b0-4aba-8d0a-e37299c70fcd"); } }
        ...
        protected override void RegisterInputParams(GH_InputParamManager pManager)
        {
            ...
            pManager.AddNumberParameter("Young modulus", "E (MPa)", "Compressive Young modulus of the material in MPa. The tensile Young modulus is set to 0.", GH_ParamAccess.item, 0.0);

            // Registration of the yield strength input
            pManager.AddNumberParameter("Yield strength", "Fy (MPa)", "Compressive yield strength of the material in MPa. The tensile yield strength is set to 0.", GH_ParamAccess.item, 0.0);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            var material = new BilinearMaterial(name, youngC * 1e6, 0.0, new Interval(-Math.Abs(fy) * 1e6, 0.0), rho); // E and fy are saved in Pa in the material object
