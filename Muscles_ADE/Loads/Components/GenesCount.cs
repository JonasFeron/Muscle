...
namespace Muscles_ADE.InitialForces
{
    public class GenesCount : GH_Component
    {
        ...
        {
            get { return new Guid("cde9e7c4-9b89-44af-9de1-ceb84dcfc435"); }
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            Guid GenePool = new Guid("21553c44-ea62-475e-a8bb-62b2a3ee5ca5"); // all GenePool component have this ID //NOT CHANGED
            foreach (IGH_DocumentObject obj in this.OnPingDocument().Objects) //lets look at all component on the current canvas
            {
                if (obj.ComponentGuid != GenePool)
                {
                    continue; //if the component is not a genepool, skip the rest and look at the next component
                }
                dynamic genepool = (dynamic)obj; //type of Genepool is: GalapagosComponents.GalapagosGeneListObject but it can't be imported with using.. No API exists to know the methods
