...
def main():
    ...
    if (key  == key_TxtFile):
        try:
            result0 = Data_str[0].lower()  # Do stuff in python
            result1 = Data_str[1].upper()  # Do stuff in python
    ...
    resultPath = r.WriteResultFile(dataPath,r.File_Test_Result,key,output_str)
