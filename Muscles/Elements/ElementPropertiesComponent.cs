...
namespace Muscles.Elements
{
    public class ElementPropertiesComponent : GH_Component
    {
        ...
        protected override void RegisterOutputParams(GH_Component.GH_OutputParamManager pManager)
        {
            ...
            pManager.AddGenericParameter("Cross Sections List", "CS list", "The cross sections used in non-linear finite element analysis.\n The list contains [CS in compression, CS in tension].", GH_ParamAccess.list); //6
            ...
            pManager.AddGenericParameter("Material List", "Mat list", "The materials used in non-linear finite element analysis.\n The list contains [Mat in compression, Mat in tension].", GH_ParamAccess.list); //8
