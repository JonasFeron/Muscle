...
namespace Muscle.Solvers
{
    public class SVDSolverComponent : GH_Component
    {
        ...
        {
            string pythonScript = AccessToAll.MainAssemble; // ensure that the python script is located in AccessToAll.pythonProjectDirectory, or provide the relative path to the script.
