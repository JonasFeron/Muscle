...
namespace Muscle.Components.ConstructFEModel
{
    ...
    public class MaterialTensionOnlyComponent : GH_Component
    {
        ...
        /// </summary>
        public MaterialTensionOnlyComponent() : base("Construct Material - Tension Only", "M", "Define a material with linear properties in tension, and null stiffness and strength in compression.", GHAssemblyName, Folder2_ConstructFEM) { }
