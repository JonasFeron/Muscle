...
class StructureObj():
    ...
    def Module_dynamics_initial(Self, PrestrainLevel):
        """
        Module that compute the natural frequency for a certain prestress and mass on the initial geometry
        Input:
        ...
        """
        assert Self.DynMasses.shape == (Self.NodesCount, )
        ...
        MassesDirection = np.repeat(Self.DynMasses,3) # Vector [3* # Nodes] containing in each direction the dynamic mass
