...
namespace Muscle.FEModel
{
	...
	{
        #region Nodes
		public double[,] NodesCoord { get; private set; } //shape (NodesCount, 3)
		public double[,] LoadsInit { get; private set; } //shape (NodesCount, 3)
		public double[,] LoadsToApply { get; private set; } //shape (NodesCount, 3)

		#endregion Nodes
        #region Supports
		public bool[] IsDOFfree { get; private set; } // [bool] - shape (3NodesCount,). Each point i is associated to its X DOF (3i), Y DOF (3i+1), Z DOF (3i+2). Each DOF can be fixed (False) or free (True).

		public double[] ReactionsInit { get; private set; }
		#endregion Supports
